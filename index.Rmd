...
The dashboard displayed by the following link provides easy access to locate retailer for inspection based on _random selection process_, and/or based on _the high risk retailers_ which were obtained based on *propensity score modeling* approach.
...
:::
[Click here to view our sample dashboard!](https://niroapps.shinyapps.io/RetailCheck/)
::::
...
# knitr::include_graphics("images/dashboard.png")
knitr::include_graphics("images/dash_map_red.png")
```
